...
class ElasticQueryBuilder
{
    ...
    */
	match(query, onFields, operator, multi_match)
	{
    ...
    */
	query()
	{
	    ...
	    if(this._$elasticObjects.match)
	    {
            ...
            {
                var _fields_as_array = this._$elasticObjects.match.fields;
	    ...
	    if(this._$elasticObjects.match_pharse)
	    {
	         _query.query.multi_match = {
                ...
                {
                    var _fields_as_array = this._$elasticObjects.match_pharse.fields;
                    if(!Array.isArray(_fields_as_array))
                    {
                        _fields_as_array = [_fields_as_array];
                    }
